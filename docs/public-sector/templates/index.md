...
These templates are digitally enabling artifacts designed for direct use in repository workflows. Copy a template into your project workspace and complete it as part of domain progression.
